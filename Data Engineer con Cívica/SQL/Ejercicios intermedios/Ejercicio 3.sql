...
--Ejercicio 03
--Crear una tabla CTE que copie la estructura de la tabla H_VENTAS,  filtrando por las ventas de la categoría deportes.
--La consulta debe contener 2 campos adicionales: 
--• Campo id_fecha, transformado a fecha que utilizaremos para filtrar las ventas entre octubre y diciembre de 2015.
--• Campo de ventas redondeado a 0 decimales, haciendo uso de la función CAST.
